...
declare module 'react-intl' {
  ...
  declare type $npm$ReactIntl$IntlShape = $npm$ReactIntl$IntlConfig & $npm$ReactIntl$IntlFormat & { now: () => number };
  ...
  declare function formatDate(value: any, options?: $npm$ReactIntl$DateTimeFormatOptions & { format: string }): string;
  declare function formatTime(value: any, options?: $npm$ReactIntl$DateTimeFormatOptions & { format: string }): string;
  ...
  declare function formatNumber(value: any, options?: $npm$ReactIntl$NumberFormatOptions & { format: string }): string;
